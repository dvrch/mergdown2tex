 ...
 * @returns {string}
 */
export function expand_wikilinks(content, vault_root, md_path) {
    let deferred5_0;
    let deferred5_1;
    try {
 ...
 * @returns {string}
 */
export function expand_wikilinks_with_index(content, vault_root, md_path, _path_index_json) {
    let deferred6_0;
    let deferred6_1;
    try {
        const ptr0 = passStringToWasm0(content, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
 ...
 * @returns {string}
 */
export function expand_wikilinks_with_vfs(content, vault_root, md_path, vfs_json) {
    let deferred6_0;
    let deferred6_1;
    try {
        const ptr0 = passStringToWasm0(content, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
 ...
 * @returns {string}
 */
export function extract_bibliography_paths(markdown_content) {
    let deferred2_0;
    let deferred2_1;
    try {
 ...
 * @returns {string}
 */
export function extract_citations(latex_body) {
    let deferred2_0;
    let deferred2_1;
    try {
 ...
 * @returns {string}
 */
export function generate_full_bibliography(citations_json, bib_paths_json, style) {
    let deferred4_0;
    let deferred4_1;
    try {
 ...
 * @returns {string}
 */
export function generate_tex_footer() {
    let deferred1_0;
    let deferred1_1;
    try {
 ...
 * @returns {string}
 */
export function generate_tex_header(profile_name, markdown_content, title_override, author_override, include_toc, include_lot, include_lof) {
    let deferred5_0;
    let deferred5_1;
    try {
 ...
 * @returns {string}
 */
export function markdown_to_latex(content, profile) {
    let deferred4_0;
    let deferred4_1;
    try {
        const ptr0 = passStringToWasm0(content, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
 ...
 * @returns {string}
 */
export function markdown_to_latex_with_vfs(content, profile, vfs_json) {
    let deferred5_0;
    let deferred5_1;
    try {
        const ptr0 = passStringToWasm0(content, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
 ...
 * @returns {string}
 */
export function prepare_latex_for_docx(tex_content) {
    let deferred2_0;
    let deferred2_1;
    try {
